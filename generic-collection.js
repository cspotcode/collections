...
GenericCollection.prototype.sorted = function (compare, by, order) {
    ...
    if (compare.by) {
        by = compare.by;
        compare = compare.compare || this.contentCompare || ShimObject.compare;
    } else {
...
GenericCollection.prototype.clone = function (depth, memo) {
    ...
    this.forEach(function (value, key) {
        clone.add(ShimObject.clone(value, depth - 1, memo), key);
    }, this);
    return clone;
};
